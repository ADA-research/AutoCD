...
class PCStable:
    """Causal discovery based on conditional independence tests.

    References
    ----------
    Colombo, Diego and Maathuis, Marloes H,
    "Order-independent constraint-based causal structure learning", JMLR 2014.

    Kalisch, Markus and Mächler, Martin and Colombo, Diego and Maathuis, Marloes H and
    Bühlmann, Peter,
    "Causal inference using graphical models with the R package pcalg",
    Journal of statistical software 2012.

    Kalisch, Markus and Bühlman, Peter,
    "Estimating high-dimensional directed acyclic graphs with the PC-algorithm", JMLR 2007.

    Ramsey, JD and Zhang, J and Spirtes, P,
    "Adjacency-Faithfulness and Conservative Causal Inference", UAI 2006.

    Spirtes, Peter and Glymour, Clark N and Scheines, Richard and Heckerman, David,
    "Causation, prediction, and search", MIT press 2000.

    Strobl, Eric V and Zhang, Kun and Visweswaran, Shyam,
    "Approximate kernel-based conditional independence tests for fast non-parametric
    causal discovery", Journal of Causal Inference 2019.
    ...
    def estimate(self, datapath, config):
        ...
        prefix = "causalcmd/pcstable_" + str(datetime.now()).replace(" ", "_")
